...
public class DataReader {
	public static Object[][] readExcel(String pathToExcel, String sheetName) throws IOException
	{
	    ...
	    XSSFWorkbook workbook = new XSSFWorkbook (fileInputStream); //get my workbook from xls (not working with xlsx)
	    XSSFSheet worksheet=workbook.getSheet(sheetName);// get workbook
	    DataFormatter formatter= new DataFormatter();
        XSSFRow row=worksheet.getRow(0);     //get first row  
